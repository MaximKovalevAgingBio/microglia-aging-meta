...
* `07_hubgene_annotation.ipynb` — Analytical pipeline for hdWGCNA-derived hub genes that calculates donor-level log2FC values (GPNMB+ vs homeostatic clusters) and applies Linear Mixed-Effects Models (LMM) to classify markers as homeostatic, neutral, or activation-related. [HTML](https://htmlpreview.github.io/?https://github.com/MaximKovalevAgingBio/microglia-aging-meta/blob/main/07_hubgene_annotation.html)
